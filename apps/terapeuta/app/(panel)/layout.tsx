...
export default async function PanelLayout({
  ...
  // cuenta con sesión debe ser la psicóloga demo de ese visitante).
  ...
  const demo = !!demoEstado?.ok && demoEstado.terapeuta_id === user.id;
  ...
  return (
    <div className="flex min-h-screen flex-col lg:flex-row">
      ...
      {demo && <ModoDemo rol="psicologo" vinculacionId={demoEstado?.vinculacion_id ?? null} />}
      ...
      <EncuestaSatisfaccion mostrar={!demo && mostrarEncuesta} />
